...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260223203436_MakeWishlistStatusAndImportanceNullable")]
    partial class MakeWishlistStatusAndImportanceNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Needs.Need", b =>
                {
                    ...
                    b.HasIndex("StatusId")
                        .HasDatabaseName("ix_needs_status_id");
            ...
            modelBuilder.Entity("Domain.Schematics.Schematic", b =>
                {
                    ...
                    b.Property<Guid?>("SchematicUsefulLinkId")
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Domain.Schematics.UsefulLink.SchematicUsefulLink", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_schematic_useful_links");

                    b.HasIndex("SchematicId")
                        .HasDatabaseName("ix_schematic_useful_links_schematic_id");

                    b.ToTable("schematic_useful_links", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Needs.Need", b =>
                {
                    ...
                    b.HasOne("Domain.Needs.Status.NeedStatus", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Schematics.UsefulLink.SchematicUsefulLink", b =>
                {
                    b.HasOne("Domain.Schematics.Schematic", null)
                        .WithMany()
                        .HasForeignKey("SchematicId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
