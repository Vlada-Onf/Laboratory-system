...
{
    public sealed class UpdateDamagedComponentReasonCommandValidator
        : AbstractValidator<UpdateDamagedComponentReasonCommand>
    {
        public UpdateDamagedComponentReasonCommandValidator()
        {
            RuleFor(x => x.Id)
