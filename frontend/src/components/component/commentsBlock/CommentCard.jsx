          ...
          {isEditing ? (
            <>
              <Button
                ...
                color="primary"
                sx={{
                  color: isDarkMode ? 'rgba(255, 255, 255, 0.9) !important' : 'inherit',
                  borderColor: isDarkMode ? 'rgba(255, 255, 255, 0.9)' : 'inherit'
                }}
                onClick={handleSave}
                disabled={!text.trim()}
              >
            ...
            <>
              <Button
                size="small"
                color="primary"
                sx={{color: isDarkMode ? 'rgba(255, 255, 255, 0.9) !important' : 'inherit'}}
